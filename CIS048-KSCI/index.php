...
<body>
    ...
    <section class="main-content">
        ...
        <div class="content">
            <section>
                <h2 class="memtitle">Home</h2>
                <hr>
			<p> Welcome to your home page! Here you will find your list of events based on organization membership. </p>
            </section>
            <div class="content">
                <section>
                    <!-- Calendar Container -->
                    <div class="container">
						...
						<h2 class="memtitle">Your Calendar</h2>
						<hr>
                            <div id="calendar"></div>
                        </div>
                        ...
                        <div class="events-container">
                            <h2 class="memtitle">Your Events</h2>
                            <hr>
                            <p id="events">
                                <?php
                                foreach ($eventData as $event) {
