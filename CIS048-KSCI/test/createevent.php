...
// Get the current date for pre-selection
$EventStartDate = date('Y-m-d H:i:s'); // You may need to modify this based on your needs
$EventEndDate = date('Y-m-d H:i:s');   // You may need to modify this based on your needs
?>
